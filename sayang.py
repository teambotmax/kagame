...
wait = {
    ...
    "Respontag":"ɴɢᴇтᴀɢ ɢuᴇ ʟᴀɢı, ɢuᴇ кuтuк ʟu ĵᴀᴅı sᴇтяıкᴀᴀɴ..!!!",
...
def help():
    ...
    key = key.title()
    helpMessage = "❂͜͡➣ " + key + " [ʙᴏᴛs кᴀɢᴀмᴇ]\n" + \
                   "❂͜͡➣" + key + "✰кᴀɢᴀмᴇ✰\n" + \
                  "❂͜͡➣ " + key + "ʜᴇʟᴘ\n" + \
                  "❂͜͡➣ " + key + "ʜᴇʟᴘ1\n" + \
                  "❂͜͡➣ " + key + "ʜᴇʟᴘ2\n" + \
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "❂͜͡➣ " + key + " [ʙᴏᴛs кᴀɢᴀмᴇ]\n" + \
                  "❂͜͡➣ " + key + "ᴛᴀɢᴀʟʟ//ɴᴀʜ\n" + \
                  "❂͜͡➣ " + key + "ɢɪɴғᴏ\n" + \
                  "❂͜͡➣ " + key + "ᴏᴘᴇɴ\n" + \
                  "❂͜͡➣ " + key + "ᴄʟᴏsᴇ\n" + \
                           ...
                           if targets == []:
                               ...
                               for target in targets:
                                   try:
                                       ...
                                       cl.createGroup("NIKMATI SAJA",[target]) 
                                       cl.createGroup("NIKMATI SAJA",[target]) 
                                       cl.createGroup("NIKMATI SAJA",[target])
                     ...
                     return
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"[ ᴛᴇᴀᴍ ʙᴏᴛs кᴀɢᴀмᴇ ]") 
...
#KICKALL
                        elif "baper" in msg.text:
                          if msg._from in admin:
                           if msg.toType == 2:
                              print("rata")
                              _name = msg.text.replace("baper","")
...
#=======update bot=======#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               group = cl.getGroup(msg.to)
                               nama = [contact.mid for contact in group.members]
                               nm1, nm2, nm3, nm4, nm5, nm6, nm7, nm8, nm9, nm10, nm11, nm12, nm13, nm14, nm15, nm16, nm17, jml = [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], len(nama)
                               if jml <= 20:
...
#=========== [ Add Sticker ] ============#                                            
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, "kibar kibar ndas mu")
