...
KAC = [cl,ki,kk,kc,kb,ke,sw]
ABC = [cl,ki,kk,kc,kb,ke,sw]
...
wait = {
    ...
    "unsend":True,
    "mention":"ɴɢɪɴᴛɪᴘ ᴀᴊᴀ sɪɴɪ ᴍᴀsᴜᴋ ɢᴀʙᴜɴɢ..!!",
    "Respontag":"ᴍɢᴇᴛᴀɢ ʟᴀɢɪ ᴛᴀᴋ ᴋᴜᴛᴜᴋ ᴊᴀᴅɪ sᴀɴᴅᴀʟ ᴊᴇᴩɪᴛ😝",
...
def help():
    ...
    helpMessage = "👉" + key + " [ᴾᴴᴷ]\n" + \
                  ...
                  "「👉]  " + key + "ʀᴇғʀᴇsʜ\n" + \
                  "「👉]  " + key + "ʀᴇsᴛᴀʀᴛ\n"+ \
                  "❂͜͡➣ [[ᴩʀᴀsᴛ ʜᴜɴᴛᴇʀ ᴋɪʟʟᴇʀ]]"
    return helpMessage

def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "🔥 " + key + " [ᴾᴴᴷ]\n" + \
                  "❂͜͡➣ " + key + "ᴛᴀɢᴀʟʟ/ɴᴀʜ\n" + \
                  "❂͜͡➣ " + key + "ɢɪɴғᴏ\n" + \
                  "❂͜͡➣ " + key + "ᴏᴘᴇɴ\n" + \
                  "❂͜͡➣ " + key + "ᴄʟᴏsᴇ\n" + \
                  ...
                  "❂͜͡➣ " + key + "ɢʀᴜᴘʟɪsᴛ\n" + \
                  "❂͜͡➣ " + key + "ᴋᴏᴍᴀɴᴅᴏ\n" + \
                  "❂͜͡➣ " + key + "ᴀᴅᴍɪɴᴀᴅᴅ @\ᴀᴅᴍɪɴᴅᴇʟʟ @\n" + \
                  "❂͜͡➣ " + key + "sᴛᴀғғᴀᴅᴅ @\sᴛᴀғғᴅᴇʟʟl @「ɴᴏᴍᴇʀ」\n" + \
                  "❂͜͡➣ " + key + "ʙᴏᴛ:ᴏɴ\oғғ\n" + \
                  "❂͜͡➣ " + key + "ʀᴇғʀᴇsʜ\n" + \
                  "❂͜͡➣ " + key + "ʙᴏᴛʀᴇғᴇᴀᴛ @\n" + \
                  "❂͜͡➣ " + key + "ᴩʀᴏᴍᴏ\n" + \
            ...
            try:
                ...
                if op.param3 in Zmid:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        cl.inviteIntoGroup(op.param1,[Zmid])
                        cl.sendMessage(op.param1,"ᴀɴᴛɪ JS sʟᴇᴅɪɴɢ")
                    else:
                        cl.kickoutFromGroup(op.param1,[op.param2])
                        cl.findAndAddContactsByMid(op.param3)
                        cl.inviteIntoGroup(op.param1,[Zmid])
                           ...
                           if targets == []:
                               ...
                               for target in targets:
                                   try:
                                       ...
                                       cl.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       cl.createGroup("ELU DISPAM GOBLOK",[target])
                                       ki.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       ki.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       ki.createGroup("ELU DISPAM GOBLOK",[target])
                                       kk.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       kk.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       kk.createGroup("ELU DISPAM GOBLOK",[target])
                                       kc.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       kc.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       kc.createGroup("ELU DISPAM GOBLOK",[target])
                                       kb.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       kb.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       kb.createGroup("ELU DISPAM GOBLOK",[target])
                                       ke.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       ke.createGroup("ELU DISPAM GOBLOK",[target]) 
                                       ke.createGroup("ELU DISPAM GOBLOK",[target])
                          ...
                          if msg._from in admin:
                            ...
                            for i in group:
                                ...
                                if ginfo == group:
                                    ...
                                    kg.leaveGroup(i)
                                    kh.leaveGroup(i)
                                    cl.sendMessage(msg.to,"ʙᴇʀʜᴀsɪʟ ᴋᴇʟᴜᴀʀ ᴅᴀʀɪ ɢʀᴏᴜᴩ " +str(ginfo.name))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                sw.sendMessage(msg.to, "ᴾᴴᴷ ˢᶦᵃᵖ ʲᵉⁿᵈʳᵃˡ")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ginfo = cl.getGroup(msg.to)
                                    cl.inviteIntoGroup(msg.to, [Zmid])
                                    cl.sendMessage(msg.to,"Grup"+str(ginfo.name)+"sᴛᴀʏ ᴅɪ ʟᴜᴀʀ ᴊᴇɴᴅʀᴀʟ")
                                except:
                                    pass           
